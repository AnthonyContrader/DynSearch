...
import it.contrader.dynsearch.config.audit.AuditEventConverter;
import it.contrader.dynsearch.domain.PersistentAuditEvent;
...
import static it.contrader.dynsearch.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
